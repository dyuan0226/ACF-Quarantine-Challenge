...
class ChallengeTest < ActiveSupport::TestCase
  ...
  # For use when we come up with the categories
  # should allow_value("First category").for(:category)
  # should allow_value("Second category").for(:category)
  # should allow_value("Third category").for(:category)
  # should allow_value("Fourth category").for(:category)
